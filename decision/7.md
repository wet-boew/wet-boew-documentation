...
For instance, if someone would add an experimental feature to turn the Canada.ca website red at version 5.2, then doesn't document it (functionnality, possibilities, examples, etc.) by version 5.3, the feature gets flagged for removal when version 5.4 or 6.0 will arrive. 

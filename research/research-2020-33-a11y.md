...
title: 1 - Accessibility assesment of Canada child benefit page of Canada.ca
modified: 2020-01-27
---
### Evaluate the accessibility conformity of the Canada child benefit page of Canada.ca
<table>
	<tr>
	...
	<tr>
    	<th>Page:</th>
		<td><a href="https://test.canada.ca/canada-child-benefit-2/post-validation/revenue-agency/services/child-family-benefits/canada-child-benefit.html">https://test.canada.ca/canada-child-benefit-2/post-validation/revenue-agency/services/child-family-benefits/canada-child-benefit.html</a></td>
 	</tr>
	<tr>
    	<th>Subject</th>
		<td>Evaluate the accessibility conformity of the Canada child benefit page of Canada.ca</td>
 	</tr>
	<tr>
    	<th>Notes:</th>
		<td></td>
...
<table class="table">
	...
	<tbody>
		...
		<tr>
			...
			<td>A</td>
			<td>Fail</td>
			<td>The order goes from left to right. However, at first, the language link is focused in prior to the Canada logo and sign in button before menu button. It should have a consistence order whether it starts from left or right.</td>
		</tr>
		<tr>
